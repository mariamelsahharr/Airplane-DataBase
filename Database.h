...
/// Contains information on multiple flights and allows the user to run commands that can affect flights, seats, and passengers
class Database
{
private:
    /// Vector containing all flights
    vector <Flight> flights;

    ///  Selected flight from [flights]
    int selectedFlight;
